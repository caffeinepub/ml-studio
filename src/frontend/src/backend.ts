...
export class Backend implements backendInterface {
    ...
    async clearPredictions(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearPredictions();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPredictions(): Promise<Array<PredictionHistory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPredictions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async savePrediction(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.savePrediction(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
